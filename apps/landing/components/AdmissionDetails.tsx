...
import { AdmissionClassData, fetchSheetData } from '../services/googleSheetsService';
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-[#020420] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-slate-500 dark:text-gray-400 text-sm">Loading admission data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020420] pb-20">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <Reveal>
            <div className="flex items-center gap-4 md:gap-6 mb-8">
              ...
              <div>
                <h1 className="text-3xl md:text-6xl font-display font-black tracking-tight text-slate-900 dark:text-white mb-1 md:mb-2">
                  Admissions
                </h1>
            ...
            <button
              ...
              className={`flex-1 group relative overflow-hidden rounded-2xl p-6 md:p-8 border transition-all duration-300 ${
                selectedSubject === 'physics'
                  ? 'bg-indigo-50 dark:bg-indigo-950/50 border-indigo-500/50 shadow-[0_0_40px_-10px_rgba(99,102,241,0.2)] dark:shadow-[0_0_40px_-10px_rgba(99,102,241,0.4)]'
                  : 'bg-white dark:bg-[#0a0c28]/60 border-slate-200 dark:border-white/5 hover:border-indigo-400 dark:hover:border-indigo-500/30'
              }`}
            >
              {/* Background SVG */}
              <div className="absolute inset-0 opacity-10 pointer-events-none">
              ...
              <div className="relative z-10 flex items-center gap-4">
                <div className={`w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl flex items-center justify-center border transition-colors ${
                  selectedSubject === 'physics'
                    ? 'bg-indigo-500/20 border-indigo-500/50 text-indigo-500 dark:text-indigo-400'
                    : 'bg-slate-100 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-400 dark:text-gray-400 group-hover:text-indigo-500 dark:group-hover:text-indigo-400'
                }`}>
                  <Atom size={28} />
                </div>
                <div className="text-left">
                  <h3 className={`text-xl md:text-2xl font-display font-bold transition-colors ${
                    selectedSubject === 'physics' ? 'text-slate-900 dark:text-white' : 'text-slate-500 dark:text-gray-300 group-hover:text-slate-900 dark:group-hover:text-white'
                  }`}>Physics</h3>
            ...
            <button
              ...
              className={`flex-1 group relative overflow-hidden rounded-2xl p-6 md:p-8 border transition-all duration-300 ${
                selectedSubject === 'biology'
                  ? 'bg-green-50 dark:bg-green-950/50 border-green-500/50 shadow-[0_0_40px_-10px_rgba(34,197,94,0.2)] dark:shadow-[0_0_40px_-10px_rgba(34,197,94,0.4)]'
                  : 'bg-white dark:bg-[#050f0a]/60 border-slate-200 dark:border-white/5 hover:border-green-400 dark:hover:border-green-500/30'
              }`}
            >
              ...
              <div className="relative z-10 flex items-center gap-4">
                <div className={`w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl flex items-center justify-center border transition-colors ${
                  selectedSubject === 'biology'
                    ...
                    : 'bg-slate-100 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-400 dark:text-gray-400 group-hover:text-green-500 dark:group-hover:text-green-400'
                }`}>
                  <Dna size={28} />
                </div>
                <div className="text-left">
                  <h3 className={`text-xl md:text-2xl font-display font-bold transition-colors ${
                    selectedSubject === 'biology' ? 'text-slate-900 dark:text-white' : 'text-slate-500 dark:text-gray-300 group-hover:text-slate-900 dark:group-hover:text-white'
                  }`}>Biology</h3>
                  <p className={`text-xs md:text-sm transition-colors ${
            ...
            {classes.map((cls) => (
              <button
                ...
                className={`group relative overflow-hidden rounded-xl md:rounded-2xl p-4 md:p-6 border transition-all duration-300 ${
                  selectedClass === cls
                    ? selectedSubject === 'physics'
                      ? 'bg-indigo-50 dark:bg-indigo-950/60 border-indigo-500/60 shadow-[0_0_30px_-5px_rgba(99,102,241,0.2)] dark:shadow-[0_0_30px_-5px_rgba(99,102,241,0.4)]'
                      : 'bg-green-50 dark:bg-green-950/60 border-green-500/60 shadow-[0_0_30px_-5px_rgba(34,197,94,0.2)] dark:shadow-[0_0_30px_-5px_rgba(34,197,94,0.4)]'
                    : 'bg-white dark:bg-[#050614]/80 border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/20'
                }`}
              >
                {/* Decorative corner */}
                ...
                <div className="text-center">
                  <div className={`text-2xl md:text-4xl font-display font-black transition-colors ${
                    selectedClass === cls
                      ...
                      : 'text-slate-400 dark:text-gray-400 group-hover:text-slate-900 dark:group-hover:text-white'
                  }`}>{cls}</div>
                  <div className={`text-[8px] md:text-xs font-mono uppercase tracking-wider mt-1 transition-colors ${
                    selectedClass === cls
                      ? selectedSubject === 'physics' ? 'text-indigo-500 dark:text-indigo-400' : 'text-green-500 dark:text-green-400'
        ...
        <div className="max-w-6xl mx-auto px-4">
          <Reveal delay={0.2}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              ...
              {/* Batch Schedule Card */}
              <GlassCard className={`!p-0 overflow-hidden border-${subjectInfo.themeColor}-500/20 hover:border-${subjectInfo.themeColor}-500/40 bg-white dark:bg-[#050614]/60`}>
                <div className={`p-6 md:p-8 border-b border-slate-200 dark:border-white/5 bg-gradient-to-r ${
                  selectedSubject === 'physics' 
                    ? 'from-indigo-50 dark:from-indigo-950/50 to-transparent' 
                    : 'from-green-50 dark:from-green-950/50 to-transparent'
                }`}>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-xl md:text-2xl font-display font-bold text-slate-900 dark:text-white">Batch Schedule</h4>
                      <p className="text-slate-500 dark:text-gray-400 text-sm">Class {selectedClass} • {subjectInfo.title}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 md:p-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5">
                      <div className="flex items-center gap-3">
                        <Calendar size={18} className={selectedSubject === 'physics' ? 'text-indigo-500 dark:text-indigo-400' : 'text-green-500 dark:text-green-400'} />
                        <span className="text-slate-500 dark:text-gray-400 font-medium">Days</span>
                      </div>
                      <span className="text-slate-900 dark:text-white font-bold">{classData.batch.days}</span>
                    </div>
                    
                    <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5">
                      <div className="flex items-center gap-3">
                        <Clock size={18} className={selectedSubject === 'physics' ? 'text-indigo-500 dark:text-indigo-400' : 'text-green-500 dark:text-green-400'} />
                        <span className="text-slate-500 dark:text-gray-400 font-medium">Timing</span>
                      </div>
                      <span className="text-slate-900 dark:text-white font-bold">{classData.batch.time}</span>
                    </div>
                  </div>
                  ...
                  <div className={`p-4 rounded-xl border ${
                    selectedSubject === 'physics'
                      ...
                      : 'bg-green-50 dark:bg-green-950/30 border-green-200 dark:border-green-500/20'
                  }`}>
                    <div className="flex items-center gap-3">
                      <div className={`w-2 h-2 rounded-full animate-pulse ${
                        selectedSubject === 'physics' ? 'bg-indigo-500' : 'bg-green-500'
                      }`}></div>
                      <span className="text-slate-500 dark:text-gray-400 text-sm">New Batch Starting</span>
                    </div>
                    <p className={`text-lg font-bold mt-1 ${
                      selectedSubject === 'physics' ? 'text-indigo-600 dark:text-indigo-300' : 'text-green-600 dark:text-green-300'
                    }`}>{classData.batch.startDate}</p>
                  </div>
                  
                  {/* Highlights */}
                  <div className="pt-4 border-t border-slate-200 dark:border-white/5">
                    <h5 className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-gray-500 mb-3">Course Highlights</h5>
              ...
              <GlassCard className={`!p-0 overflow-hidden border-${subjectInfo.themeColor}-500/20 hover:border-${subjectInfo.themeColor}-500/40 bg-white dark:bg-[#050614]/60`}>
                <div className={`p-6 md:p-8 border-b border-slate-200 dark:border-white/5 bg-gradient-to-r ${
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-xl md:text-2xl font-display font-bold text-slate-900 dark:text-white">Fee Structure</h4>
                      <p className="text-slate-500 dark:text-gray-400 text-sm">Class {selectedClass} • {subjectInfo.title}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 md:p-8 space-y-6">
                  {/* Fee Options */}
                  <div className="space-y-4">
                    <div className="group p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/20 transition-all cursor-pointer">
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="text-slate-500 dark:text-gray-400 text-sm">Monthly</span>
                          <div className="flex items-center gap-1 mt-1">
                            <IndianRupee size={18} className="text-slate-900 dark:text-white" />
                            <span className="text-2xl font-display font-bold text-slate-900 dark:text-white">{classData.fees.monthly.toLocaleString()}</span>
                            <span className="text-slate-400 dark:text-gray-500 text-sm">/month</span>
                          </div>
                        </div>
                        <ChevronRight size={20} className="text-slate-400 dark:text-gray-500 group-hover:text-slate-900 dark:group-hover:text-white transition-colors" />
                      </div>
                    </div>
                    
                    <div className={`group p-4 rounded-xl border transition-all cursor-pointer ${
                      selectedSubject === 'physics'
                        ? 'bg-indigo-50 dark:bg-indigo-950/30 border-indigo-300 dark:border-indigo-500/30 hover:border-indigo-400 dark:hover:border-indigo-500/50'
                        : 'bg-green-50 dark:bg-green-950/30 border-green-300 dark:border-green-500/30 hover:border-green-400 dark:hover:border-green-500/50'
                    }`}>
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="flex items-center gap-2">
                            <span className={selectedSubject === 'physics' ? 'text-indigo-600 dark:text-indigo-300' : 'text-green-600 dark:text-green-300'} style={{fontSize: '14px'}}>Quarterly</span>
                          ...
                          <div className="flex items-center gap-1 mt-1">
                            <IndianRupee size={18} className="text-slate-900 dark:text-white" />
                            <span className="text-2xl font-display font-bold text-slate-900 dark:text-white">{classData.fees.quarterly.toLocaleString()}</span>
                            <span className="text-slate-400 dark:text-gray-500 text-sm">/3 months</span>
                          </div>
                        </div>
                    ...
                    <div className="group p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/20 transition-all cursor-pointer">
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="text-slate-500 dark:text-gray-400 text-sm">Yearly</span>
                            <span className="text-[10px] px-2 py-0.5 rounded-full font-bold bg-amber-500/20 text-amber-400">BEST VALUE</span>
                          </div>
                          <div className="flex items-center gap-1 mt-1">
                            <IndianRupee size={18} className="text-slate-900 dark:text-white" />
                            <span className="text-2xl font-display font-bold text-slate-900 dark:text-white">{classData.fees.yearly.toLocaleString()}</span>
                            <span className="text-slate-400 dark:text-gray-500 text-sm">/year</span>
                          </div>
                        </div>
                        <ChevronRight size={20} className="text-slate-400 dark:text-gray-500 group-hover:text-slate-900 dark:group-hover:text-white transition-colors" />
                      </div>
                  ...
                  <div className={`p-4 rounded-xl border ${
                    selectedSubject === 'physics'
                      ? 'bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/40 dark:to-purple-950/20 border-indigo-200 dark:border-indigo-500/20'
                      : 'bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-950/40 dark:to-teal-950/20 border-green-200 dark:border-green-500/20'
                  }`}>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h5 className="text-slate-900 dark:text-white font-bold text-sm mb-1">Scholarships</h5>
                        <p className={`text-sm ${
                          selectedSubject === 'physics' ? 'text-indigo-500 dark:text-indigo-300/80' : 'text-green-600 dark:text-green-300/80'
                        }`}>Coming Soon</p>
                      </div>
                    </div>
                  </div>
      ...
      <div className="max-w-6xl mx-auto px-4 mt-12">
        <Reveal>
          <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-indigo-50 via-purple-50 to-indigo-50 dark:from-indigo-950/60 dark:via-purple-950/40 dark:to-indigo-950/60 border border-indigo-200 dark:border-indigo-500/20 p-6 md:p-10">
            {/* Background Effects */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                ...
                <h3 className="text-2xl md:text-3xl font-display font-extrabold text-slate-900 dark:text-white mb-2">
                  Ready to Start Your Journey?
                </h3>
                <p className="text-slate-500 dark:text-gray-400 text-sm md:text-base max-w-md">
